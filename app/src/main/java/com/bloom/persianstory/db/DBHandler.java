  ...
  implements StoryListener
{
  ...
  public boolean checkdb()
  {
    try
  {
    SQLiteDatabase localSQLiteDatabase2 = SQLiteDatabase.openDatabase("data/data/ir.tg.bahar/databases/db", null, 1);
  ...
  public void copydatabase()
    throws IOException
  {
    FileOutputStream localFileOutputStream = new FileOutputStream("data/data/ir.tg.bahar/databases/db");
